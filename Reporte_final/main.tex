...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\titulo{Titulo}%titulo del documento
\def\materia{Curso: Sistemas de control LRT3082-sección} %Clave nombre de la materia y sección
\def\curso{Sistemas de control} %Nombre de la materia para footnote
\def\fecha{Mes dia, 2022} %En formato mes, dia año
\def\equipo {Equipo}%Verificar en blackboard el número asignado
...
\lstinputlisting[language=matlab,caption=Código desde archivo]{codigos/FT.m}
\newpage
